 ...
 */ export function simulateDragDrop(source, target, backend) {
 ...
 */ export function simulateDragHover(source, target, backend) {
    const sourceHandlerId = getHandlerId(source);
    const targetHandlerId = getHandlerId(target);
    act(()=>{
        backend.simulateBeginDrag([
 ...
 * @param target The target element
 * @param backend The test backend
 */ export function simulateDrag(source, backend) {
    const sourceHandlerId = getHandlerId(source);
    act(()=>{
        backend.simulateBeginDrag([
            sourceHandlerId
...
export function getHandlerId(provider) {
